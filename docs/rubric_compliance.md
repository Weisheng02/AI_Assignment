...
| Platform intents, entities and responses | 36 source intents, 5 custom entities, 8 parameters and fallback/welcome intents in the validated Dialogflow ZIP | Met as an importable artifact; authenticated cloud testing remains external |
| Platform additional functionality | Five custom entities, eight parameters, annotated phrases, required-slot prompting, parameter-aware official-source responses and fallback handling | Met as an importable artifact; authenticated Dialogflow screenshots remain external |
